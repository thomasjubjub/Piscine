...
class WidgetCheckBox : public Widget
{
    ...
    public :
        ...
        bool get_value() { return m_N; }
        void set_value(bool value) { m_N = value; }
};
...
class WidgetVSlider : public Widget
{
    protected :
        ...
        int m_rail_color = BLEU;
        int m_handle_color = ROUGE;
    ...
    public :
        ...
        double get_value() { return typed(m_N); }
        void limit_to_range() { if (m_N<m_min) m_N=m_min; if (m_N>m_max) m_N=m_max; }
        void set_value(double value) { m_N = value; m_N =get_value(); limit_to_range(); }
...
class WidgetBox : public Widget
{
    protected :
        ...
        //Les WidgetBox sont les petites images avec leur cadre

        bool m_moveable = false; //si false, seules les widget box peuvent etre bougées

        // La WidgetBox reste dans le cadre de son parent (préférable)
        bool m_contained = true; //si true, les widgetbox restent dans le cadre
...
/// Ceci peut être étendu en étendant le code WidgetInfluence::draw
...
class WidgetInfluence : public Widget
{
    protected :
