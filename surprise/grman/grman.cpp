...
#define MODE_EcosystemeIQUE GFX_AUTODETECT_WINDOWED
//#define MODE_EcosystemeIQUE GFX_AUTODETECT_FULLSCREEN
...
Frame page_frame;
Widget *gui_over = nullptr; /// petit carrés avec les clowns
Widget *gui_last_over = nullptr;
Widget *gui_focus = nullptr;
Widget *gui_leave = nullptr;


/// Gestion des contenus Ecosystemeiques (fichiers images)
...
void init()
{
   ...
   allegro_init();
    ...
    if (set_gfx_mode(MODE_EcosystemeIQUE,LARGEURECRAN,HAUTEURECRAN,0,0)!=0)
    {
