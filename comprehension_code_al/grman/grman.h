...
/// Ecosystemeic Manager is a collection of functions and globals
...
#include "grman_couleurs.h" /// là où sont toutes les fonctions de coloriage et tout ça
#include "coords.h"
...
extern int page_color; /// extern sert à derclarer cette variable pour n'importe quelle classe ou fontion

// Le buffer sur lequel tout est dessiné
extern BITMAP *page; /// extern sert à derclarer cette variable pour n'importe quelle classe ou fontion

// La frame associée pour les widgets
extern Frame page_frame; /// extern sert à derclarer cette variable pour n'importe quelle classe ou fontion
...
/// Buffer et sorties Ecosystemeiques
...
/// Auxiliaires : compléments aux fonctions Ecosystemeiques allegro
